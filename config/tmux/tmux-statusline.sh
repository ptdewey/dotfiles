...
bg=$(get_tmux_option "@minimal-tmux-bg" 'color02')
...
tmux set-option -g window-status-current-format "#[bg=${bg},fg=color07] ${window_status_format}#{?window_zoomed_flag,${expanded_icon}, }"
